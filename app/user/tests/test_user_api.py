...
class PrivateUserApiTests(TestCase):
    """Test API that requres authentication. """

    def setUp(self):
        self.user = create_user(email='test@example.com', password='testpass123', name='Test User')
        self.client = APIClient()
    ...
    def test_update_user_profile(self):
        """Test updating user profile for the authenticate user"""
        payload = {
            'name': 'Updated Name',
